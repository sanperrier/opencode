...
| iteration-lead | This file, overview, phase 1, phase 2, phase 4, roles, escalation, output style, current spec/plan |
...
3. Delegate implementation to focused-coder and review to focused-code-reviewer, with at most 3 rejection rounds.
4. Perform lead-level alignment review, present to the user, and update plan/knowledge after finalization.
